...
**Status:** ACTIVE PUBLICATION / PUBLIC-FACING ARTICLE + DOCUMENT SURFACE
...
RLR takes source-backed work from the living ecology and translates it into public material that can stand on its own without forcing readers to tour the private repository structure.

```text
current source body
-> preserve claim / evidence / uncertainty / provenance
-> decide what a public reader actually needs
...
Publication does not become source authority. Public readability does not grant permission to erase provenance, uncertainty, disagreement, evidence class, or transformation history.

Grow folders from actual publication demand rather than mirroring the internal taxonomy of UNUM.

> Do the deep work where it belongs. Bring the useful part to people. Keep the source. Keep the truth. Do not make the public reader tour the whole house.
